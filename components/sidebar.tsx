...
import { Calendar, Home, LogOut, User, X } from "lucide-react"
...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  // close on navigation when mobile (if onClose provided)
  // eslint-disable-next-line react-hooks/rules-of-hooks
  ;(function watchPathname() {
    const prev = pathname
    // noop: keep reference to pathname so lint doesn't complain; actual effect handled by parent layout
  })()
  ...
  return (
    <>
      ...
      <div
        className={`fixed inset-y-0 left-0 z-50 w-64 transform transition-transform duration-200 bg-white border-r border-gray-200 flex flex-col md:hidden ${
